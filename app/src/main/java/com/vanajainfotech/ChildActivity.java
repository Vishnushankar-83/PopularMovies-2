...
import com.vanajainfotech.Adapters.ReviewsAdapter;
import com.vanajainfotech.Adapters.TrailersAdapter;
import com.vanajainfotech.DataList.FeedMovieVideo;
import com.vanajainfotech.DataList.FeedUserReviews;
import com.vanajainfotech.android.popularmovies.BuildConfig;
import com.vanajainfotech.data.PopularMovieDbHelper;
import com.vanajainfotech.utilities.FavoriteMovieUtils;
import com.vanajainfotech.utilities.NetworkUtils;
...
public class ChildActivity extends AppCompatActivity {
    ...
    @BindView(com.vanajainfotech.android.popularmovies.R.id.tv_releaseDate_child_activity)  TextView mReleaseDateText;

    @BindView(com.vanajainfotech.android.popularmovies.R.id.tv_voteReverage_child_activity)  TextView mVoteAverage;

    @BindView(com.vanajainfotech.android.popularmovies.R.id.tv_overview)  TextView mOverViewText;

    @BindView(com.vanajainfotech.android.popularmovies.R.id.iv_poster_child_activity)  ImageView mThumbnailImage;

    @BindView(com.vanajainfotech.android.popularmovies.R.id.tv_runtime_child_activity)  TextView mRuntimeText;

    @BindView(com.vanajainfotech.android.popularmovies.R.id.favorite_checkBox)  CheckBox mFavoriteCheck;

    @BindView(com.vanajainfotech.android.popularmovies.R.id.rv_trailsForYoutube)  RecyclerView mTrailerRecycleView;

    @BindView(com.vanajainfotech.android.popularmovies.R.id.rv_userReviews)  RecyclerView mReviewsRecycleView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.vanajainfotech.android.popularmovies.R.layout.detailed_page);
        ...
        if (extrasForDetails != null) {
            ...
            View viewActionBar = getLayoutInflater().inflate(com.vanajainfotech.android.popularmovies.R.layout.action_bar, null);
            ActionBar.LayoutParams params = new ActionBar.LayoutParams(//Center the textview in the ActionBar !
                    ActionBar.LayoutParams.WRAP_CONTENT,
                    ActionBar.LayoutParams.MATCH_PARENT,
                    Gravity.CENTER);
            TextView textViewTitle =  viewActionBar.findViewById(com.vanajainfotech.android.popularmovies.R.id.toolBar_title);
            ...
            mVoteAverage.setText(getString(com.vanajainfotech.android.popularmovies.R.string.vote_count, String.valueOf(extrasForDetails.getDouble("voteAverage"))));
    ...
    private class FetchMovieTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPostExecute(String movieResponse) {
            if (movieResponse.contains("runtime")) {
                ...
                mRuntimeText.setText(String.valueOf(RuntimeHour) +  getString(com.vanajainfotech.android.popularmovies.R.string.space) +
                        (RuntimeHour == 1? getString(com.vanajainfotech.android.popularmovies.R.string.hour) : getString(com.vanajainfotech.android.popularmovies.R.string.hours)) +
                        getString(com.vanajainfotech.android.popularmovies.R.string.space) + RuntimeMin +  getString(com.vanajainfotech.android.popularmovies.R.string.space) + getString(com.vanajainfotech.android.popularmovies.R.string.runtime_text));
