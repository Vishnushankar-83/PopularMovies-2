...
import com.vanajainfotech.DataList.JSONResultList;
...
public class SearchResultFragment extends Fragment implements MovieAdapter.ListItemClickListener {
    ...
    @BindView(com.vanajainfotech.android.popularmovies.R.id.researchresult_linearlayout)
    ...
    @BindView(com.vanajainfotech.android.popularmovies.R.id.rv_searchResult)
     RecyclerView mRecycleView;

    @BindView(com.vanajainfotech.android.popularmovies.R.id.tv_searchResultTitle)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.vanajainfotech.android.popularmovies.R.layout.fragment_search_result, container, false);
    ...
    private final Response.Listener<String> onPostsLoadedPopular = new Response.Listener<String>() {
        ...
        public void onResponse(String response) {
            ...
            if (ResultMoviesList == null || ResultMoviesList.size() == 0) {
                ...
                mSearchTitle.setText(getString(com.vanajainfotech.android.popularmovies.R.string.searchNoResult, mQueryMovieTitle));
            } else {

                mSearchTitle.setText(getString(com.vanajainfotech.android.popularmovies.R.string.searchResult_title, mQueryMovieTitle));
